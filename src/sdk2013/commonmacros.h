...
#define _SIGSEGV_SDK2013_OVERRIDE__PUBLIC_TIER0_COMMONMACROS_H 1
...
constexpr IndexType ClampedArrayIndex( const T (&buffer)[N], IndexType index )
{
	NOTE_UNUSED( buffer );
...
constexpr T ClampedArrayElement( const T (&buffer)[N], unsigned int uIndex )
{
