#ifndef _INCLUDE_SIGSEGV_UTIL_FLOAT16_H_
#define _INCLUDE_SIGSEGV_UTIL_FLOAT16_H_
...
inline void _float32(float* __restrict out, const uint16_t in) {
    uint32_t t1;
    uint32_t t2;
    uint32_t t3;
...
inline void _float16(uint16_t* __restrict out, const float in) {
