...
GlobalThunkRW<IVDebugOverlay *> debugoverlay("debugoverlay");
...
namespace NDebugOverlay
{
	...
	void BoxDuration(const Vector& origin, const Vector& mins, const Vector& maxs, const Vector& forward, int r, int g, int b, int a, float flDuration)               { ft_BoxDirection(origin, mins, maxs, forward, r, g, b, a, flDuration); }
	...
	void Line(const Vector& origin, const Vector& target, int r, int g, int b, bool noDepthTest, float flDuration)                                                    { ft_Line(origin, target, r, g, b, noDepthTest, flDuration); }
	...
	void ScreenText(float fXpos, float fYpos, const char *text, int r, int g, int b, int a, float flDuration)                                                         { ft_ScreenText(fXpos, fYpos, text, r, g, b, a, flDuration); }
