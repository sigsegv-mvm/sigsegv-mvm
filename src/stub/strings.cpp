...
GlobalThunk<const char[0x104][10]> g_szBotModels               ("g_szBotModels");
GlobalThunk<const char[0x104][10]> g_szBotBossModels           ("g_szBotBossModels");
GlobalThunk<const char[0x104][10]> g_szPlayerRobotModels       ("g_szPlayerRobotModels");
