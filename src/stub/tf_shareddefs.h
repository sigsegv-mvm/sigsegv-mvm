...
enum
{
	TF_LOADOUT_POSITION_INVALID   = -1,
	TF_LOADOUT_POSITION_PRIMARY   =  0,
	TF_LOADOUT_POSITION_SECONDARY =  1,
	TF_LOADOUT_POSITION_MELEE     =  2,
	TF_LOADOUT_POSITION_UTILITY   =  3,
	TF_LOADOUT_POSITION_BUILDING  =  4,
	TF_LOADOUT_POSITION_PDA       =  5,
	TF_LOADOUT_POSITION_PDA2      =  6,
	TF_LOADOUT_POSITION_HEAD      =  7,
	TF_LOADOUT_POSITION_MISC      =  8,
	TF_LOADOUT_POSITION_ACTION    =  9,
	TF_LOADOUT_POSITION_MISC2     = 10,
	TF_LOADOUT_POSITION_TAUNT     = 11,
	TF_LOADOUT_POSITION_TAUNT2    = 12,
	TF_LOADOUT_POSITION_TAUNT3    = 13,
	TF_LOADOUT_POSITION_TAUNT4    = 14,
	TF_LOADOUT_POSITION_TAUNT5    = 15,
	TF_LOADOUT_POSITION_TAUNT6    = 16,
	TF_LOADOUT_POSITION_TAUNT7    = 17,
	TF_LOADOUT_POSITION_TAUNT8    = 18,
};
...
{
	switch (slot) {
	case TF_LOADOUT_POSITION_HEAD:
	case TF_LOADOUT_POSITION_MISC:
	case TF_LOADOUT_POSITION_MISC2:
		return true;
	default:
		return false;
	}
